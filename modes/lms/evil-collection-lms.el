...
(defun evil-collection-lms-setup ()
  ...
  (evil-collection-bind 'next-item     'lms-ui-playing-now-mode-map 'lms-ui-playing-now-next)
  (evil-collection-bind 'prev-item     'lms-ui-playing-now-mode-map 'lms-ui-playing-now-prev)
  (evil-collection-bind 'next-section  'lms-ui-playing-now-mode-map 'lms-ui-playing-now-next)
  (evil-collection-bind 'prev-section  'lms-ui-playing-now-mode-map 'lms-ui-playing-now-prev)
  ...
  (evil-collection-define-key 'normal 'lms-ui-track-info-mode-map
    ...
    "gh"            'lms-ui-playing-now-help)
  (evil-collection-bind 'next-item     'lms-ui-track-info-mode-map 'lms-ui-track-info-next)
  (evil-collection-bind 'prev-item     'lms-ui-track-info-mode-map 'lms-ui-track-info-prev)
  (evil-collection-bind 'next-section  'lms-ui-track-info-mode-map 'lms-ui-track-info-next)
  (evil-collection-bind 'prev-section  'lms-ui-track-info-mode-map 'lms-ui-track-info-prev)
  (evil-collection-bind 'quit          'lms-ui-track-info-mode-map 'evil-collection-lms-ui-track-info-mode-quit)
  (evil-collection-bind 'describe-mode 'lms-ui-track-info-mode-map 'lms-ui-playing-now-help)
