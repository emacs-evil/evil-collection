...
(defun evil-collection-mu4e-conversation-setup ()
  ...
  (evil-collection-bind 'mu4e-conversation-map
                        'next-item 'mu4e-conversation-next-message
                        'prev-item 'mu4e-conversation-previous-message
                        'next-section 'mu4e-conversation-next-message
                        'prev-section 'mu4e-conversation-previous-message
                        'quit 'mu4e-conversation-quit))
